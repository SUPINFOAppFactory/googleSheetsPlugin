describe('Unit: googleAppsSheetsPluginContent: Services', function () {
  ...
  describe('Unit : DataStore Factory', function () {
    ...
    beforeEach(module('googleAppsSheetsPluginContent', function ($provide) {
  ...
  it('DataStore.save should exist and be a function', function () {
    ...
    it('DataStore.get should return success', function () {
      ...
      DataStore.get(TAG_NAMES.GOOGLE_APPS_SHEETS_DATA).then(success, error);
      $rootScope.$digest();
    ...
    it('DataStore.update should return success', function () {
      ...
      DataStore.update( 123, TAG_NAMES.GOOGLE_APPS_SHEETS_DATA, null).then(success, error);
      $rootScope.$digest();
      expect(result).toEqual('Success');
    });
    ...
    it('DataStore.save should return success', function () {
      ...
      DataStore.save( 123, TAG_NAMES.GOOGLE_APPS_SHEETS_DATA, null).then(success, error);
      $rootScope.$digest();
      expect(result).toEqual('Success');
    });
  })
